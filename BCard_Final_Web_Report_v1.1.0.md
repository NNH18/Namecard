...
Trạng thái kiến trúc hiện hành đã chuyển sang IndexedDB theo tài khoản, Supabase Auth/PostgreSQL/RLS/private Storage, sync theo object/version, idempotency, reconciliation, provenance và Company Research server-side. Hạ tầng web đã được triển khai lên GitHub Pages/Supabase và kiểm thử live bằng dữ liệu giả. Legal & Store Gate, dữ liệu thật, native device testing, backup/restore và incident ownership vẫn là gate độc lập.
