(function (root, factory) {
  ...
  function validateResearchOutput(value) {
    ...
    return {
      ...
      evidence: value.evidence.map(item => ({ fact_key: String(item.fact_key), source_url: item.source_url, excerpt: String(item.excerpt).slice(0, 500), retrieved_at: item.retrieved_at })),
